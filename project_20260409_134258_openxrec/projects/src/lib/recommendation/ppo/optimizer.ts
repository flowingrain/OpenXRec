...
export class PPOOptimizer {
  ...
  getStats(): {
    ...
    return {
      version: this.modelState.version,
      totalSteps: this.modelState.totalSteps,
      totalEpisodes: this.modelState.totalEpisodes,
      avgReward: this.modelState.avgReward,
      bestReward: this.modelState.bestReward,
      bufferSize: this.replayBuffer.length,
      lastUpdated: this.modelState.lastUpdated,
      adaptiveEnabled: this.enableAdaptive,
      hyperparams: this.adaptiveAdjuster.getCurrentParams(),
    };
  }
