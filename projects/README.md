...
- [OpenXRec新架构设计](./docs/OpenXRec新架构设计.md)
- [OpenXRec交互设计方案](./docs/OpenXRec交互设计方案.md)
- [推荐引擎实现详解](./docs/推荐引擎实现详解.md)
- [智能体序列推荐系统设计](./docs/智能体序列推荐系统设计.md)
- [动态配置系统设计](./docs/动态配置系统设计.md)
- [知识图谱动态类型与交互更新说明](./docs/知识图谱动态类型与交互更新说明.md)
